...
class Rectangle:
    ...
    def __del__(self):
        """descructor to print a message when Rectangle instance is deleted."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Raises:
            TypeError: If rectangles are not instances of class Rectangle.

        Returns:
            Rectangle: The bigger rectangle instance.
        """
